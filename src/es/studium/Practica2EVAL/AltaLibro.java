...
public class AltaLibro extends Frame
		implements
			WindowListener,
			ActionListener {
	...
	Label lblPaginas = new Label("Paginas:");
	TextField txtPaginas = new TextField(20);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (objetoPulsado.equals(btnLimpiar)) {
			...
			// Hacer el INSERT
			int respuesta = insertar(con, "libro", txtTitulo.getText(),
					txtEditorial.getText(), txtISBN.getText(),
					txtPaginas.getText());

			// Mostramos resultado
			if (respuesta == 0) {
				System.out.println("Alta de libro correcta");
			} else {
				System.out.println("Error en el alta de libro");
			}
	...
	public int insertar(Connection con, String tabla, String tituloLibro,
			String editorialLibro, String isbnLibro, String paginasLibro) {
		int respuesta = 0;
		try {
			// Creamos un STATEMENT para una consulta SQL INSERT.
			Statement sta = con.createStatement();
			String cadenaSQL = "INSERT INTO " + tabla + " VALUES (null, '"
					+ tituloLibro + "', '" + editorialLibro + "', '" + isbnLibro
					+ "','" + paginasLibro + "')";
